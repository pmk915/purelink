...
|---|---:|---:|---:|---:|---:|---:|---:|
| `fixed_chunk_only` | 50.0% | 50.0% | 20.0% | 25.0% | 25.6% | 100.0% | 8.8 |
| `block_aware_chunk_only` | 65.0% | 65.0% | 35.0% | 45.0% | 27.7% | 100.0% | 12.3 |
| `block_aware_hybrid_text` | 60.0% | 60.0% | 20.0% | 40.0% | 21.7% | 100.0% | 16.9 |
| `block_aware_graph_vector_mix` | 40.0% | 40.0% | 25.0% | 30.0% | 22.9% | 100.0% | 14.2 |
| `block_aware_auto` | 50.0% | 50.0% | 30.0% | 45.0% | 22.7% | 100.0% | 15.4 |
...
| `block_aware_graph_vector_mix` | technical | 33.3% | 33.3% | 26.4% |
...
`block_aware_chunk_only` vs `fixed_chunk_only`: retrieval_hit delta +15.0pp, citation_hit delta +15.0pp, keyword_coverage delta +2.1pp. This supports the comparison for block-aware chunking under chunk_only without assuming improvement where the data does not show it.
...
`block_aware_graph_vector_mix` vs `block_aware_chunk_only`: retrieval_hit delta -25.0pp, citation_hit delta -25.0pp, keyword_coverage delta -4.8pp. This supports the comparison for graph_vector_mix over block-aware chunks without assuming improvement where the data does not show it.

...
export const zh: Messages = {
  ...
  qa: {
    ...
    citationTitle: (number: string) => `引用 ${number}`,
    viewCitationAria: (number: string, documentName: string) =>
      `查看引用 ${number}：${documentName}`,
    closeCitation: "关闭引用",
    citationNavigation: "当前回答中的引用",
    sourceDetails: "来源详情",
    quotedEvidence: "引用原文",
    ...
    page: "页码",
    characterRange: "字符范围",
    limitedSourceDetails: "该引用的来源详情有限。",
    citationUnknownDocument: "未知文档",
    finalEvidenceNote: "这里展示的是回答实际引用的最终证据片段。",

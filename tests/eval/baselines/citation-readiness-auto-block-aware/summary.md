...
- Run id: `20260713-054136-auto-block_aware`
- Created at: `2026-07-13T05:41:36.155725+00:00`
- Commit: `056e2b6`
...
| mean_evidence_precision | 31.1% (n=44) |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| `entity_attribute` | 8 | 8 / 8 (100.0%) | 8 / 8 (100.0%) | 6 / 8 (75.0%) | 8 / 8 (100.0%) | 8 / 8 (100.0%) | 26.7% (n=7) |
| `entity_definition` | 8 | 8 / 8 (100.0%) | 8 / 8 (100.0%) | 7 / 8 (87.5%) | 8 / 8 (100.0%) | 8 / 8 (100.0%) | 52.9% (n=8) |
...
| `technical` | 10 | 9 / 10 (90.0%) | 9 / 10 (90.0%) | 5 / 10 (50.0%) | 10 / 10 (100.0%) | 9 / 10 (90.0%) | 19.4% (n=9) |

## 4. Metrics by Selected Mode

| Group | Cases | retrieval_hit | citation_hit | expected_evidence_hit | router_accuracy | evidence-gate answerability | evidence_precision |
|---|---:|---:|---:|---:|---:|---:|---:|
| `chunk_only` | 30 | 24 / 25 (96.0%) | 24 / 25 (96.0%) | 18 / 25 (72.0%) | 30 / 30 (100.0%) | 30 / 30 (100.0%) | 31.9% (n=25) |
| `graph_vector_mix` | 8 | 8 / 8 (100.0%) | 8 / 8 (100.0%) | 7 / 8 (87.5%) | 8 / 8 (100.0%) | 8 / 8 (100.0%) | 61.3% (n=8) |
| `hybrid_text` | 7 | 7 / 7 (100.0%) | 7 / 7 (100.0%) | 3 / 7 (42.9%) | 7 / 7 (100.0%) | 6 / 7 (85.7%) | 9.0% (n=6) |
| `overview` | 5 | 3 / 5 (60.0%) | 3 / 5 (60.0%) | 2 / 5 (40.0%) | 5 / 5 (100.0%) | 5 / 5 (100.0%) | 5.7% (n=5) |
...
| `reason_reprocess_old_docs` | 为什么旧 PureLink 文档需要重新处理？ | do not automatically receive new citation-unit behavior, reprocess the document and rebuild the vector index | 特点：高性能; Adaptation: concise paraphrase for deterministic PureLink evaluation | `chunk_only` | expected_evidence_not_selected |

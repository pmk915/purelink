...
async def list_knowledge_base_graph_entities_endpoint(
    knowledge_base_id: int,
    db: DBSession,
    current_user: CurrentUser,
...
async def get_knowledge_base_graph_entity_endpoint(
    knowledge_base_id: int,
    entity_id: int,
    db: DBSession,
    current_user: CurrentUser,
...
async def get_personal_document_status_endpoint(
    knowledge_base_id: int,
    document_id: int,
    db: DBSession,
    current_user: CurrentUser,
...
async def list_personal_processing_jobs_endpoint(
    knowledge_base_id: int,
    db: DBSession,
    current_user: CurrentUser,
